    ...
    <div class="register-container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('kitchen.register.submit') }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="kitchen_description" id="kitchen_description" rows="4"
                            placeholder="Provide a detailed description" required>{{ old('kitchen_description') }}</textarea>
                    </div>
